...
public class Menu {
    public static void MenuPrincipal() throws SQLException {
        ...
        do {
            ...
            System.out.println("1 -MENU POUR LES VILLES");
            System.out.println("2 -MENU POUR LES HISTORIQUE DE VILLES ");
            System.out.println("3 -QUETTER ..");
    ...
    public static void cityMenu() throws SQLException {
        ...
        do {
            System.out.println("[-------------------------------Menu pour les villes -------------------------------]");
            System.out.println("[1. Ajouter une ville :");
            System.out.println("2. maise a jour une ville :");
            System.out.println("3. supprimer une ville :  ");
            System.out.println("4. laire une ville :");
            System.out.println("5. recherch une ville [ nom]");
